...
def format_display_command(idxx, page, message):
...
def send_message():
    ...
    command = format_display_command(idxx, 'A', message)
...
message_label.grid(row=4, column=0, pady=5)

message_entry = tk.Entry(frame, width=50)
message_entry.grid(row=4, column=1, pady=5)
